...
- it could assign new assignments (so that this code isn't client-side)
  - or it could check that your the assignments you're submitting are as would be generated by the server, and if not they don't count towards progress
